...
// echo $_SESSION['emp'];
$employeeDetails = $db->getEmployees($_SESSION['emp']);
$loc = $employeeDetails;
// $users = $db->allPVacinated($loc[0]['center_id']);
$users = $db->allPVacinated_procedure($loc[0]['center_id']);
$centerName = $db->getCenterName($loc[0]['center_id']);
